...
1. **Vue.js Frontend**
   ...
   - Les balises meta PWA doivent suivre les recommandations actuelles : utiliser uniquement `mobile-web-app-capable` (et non plus `apple-mobile-web-app-capable`). Voir docs/technical.md pour les détails et la justification.
