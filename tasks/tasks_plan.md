...
6. **Drawing Tools**
   ...
   - [ ] Afficher le champ 'Nom' pour les GeoNotes dans DrawingTools.vue au-dessus de la catégorie, de la même manière que pour les lignes et polygones.
   - [ ] Allow click on existing shapes when no drawing tool is active to enter selection mode and enable control-point editing
